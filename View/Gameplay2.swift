        ...
        if timerRunning {
            ...
            ZStack{
                ...
                Group{
                    ...
                    Text(results2[0].description)
                        .position(x:210, y: 525)
                    Text(results2[1].description)
                        .position(x:417, y: 525)
                    Text(results2[2].description)
                        .position(x:624, y: 525)
                    Text(results2[3].description)
                        .position(x:210, y: 655)
                    Text(results2[4].description)
                        .position(x:417, y: 655)
                    Text(results2[5].description)
                ...
                //Botões de click
                InvisibleButtons2(isRunning: $timerRunning)
